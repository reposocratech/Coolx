...
class userController {
  ...
  selectOneUser = (req, res) => {
    ...
    let sqlProject = `select * from image, project, user where user.user_id = project.user_id and project.project_id = image.project_id and user.user_id = ${user_id} group by project.project_id`;
