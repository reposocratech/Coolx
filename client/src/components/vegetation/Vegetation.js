  ...
  return (
    <Container fluid>
      ...
      <Row className="tarjetas-vegetacion">
        <Col md={3} className="veg-card-container">
            ...
            <Row className="dividir-vegetacion p-0 m-0">
              ...
              <Col lg={8} className="p-0 d-flex align-items-end">
                <div>
                  ...
                  <h1>{projectPayed && projectPayed[0].avg_height} m</h1>
                </div>
              </Col>
            </Row>
            ...
            <Row className="dividir-vegetacion p-0 m-0">
              ...
              <Col lg={8} className="p-0 d-flex align-items-end">
                <div>
                  ...
                  <h1>
                    {projectPayed && projectPayed[0].standard_calcination}
                  </h1>
                </div>
              </Col>
            </Row>
            ...
            <Row className="dividir-vegetacion p-0 m-0">
              ...
              <Col lg={8} className="p-0 d-flex align-items-end">
                <div>
                  <h6>Coeficiente entre -1 - +1</h6>
                  <h1>
                    {projectPayed && projectPayed[0].atm_vegetation_resistant}
                  </h1>
                </div>
              </Col>
            </Row>
